...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //obtener instancia de FirebaseAnalitics

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);

        //bundel para agregar parametros
        //de la isguiente manera se lanza las analiticas

        Bundle bundle = new Bundle();
        //se envia clave-> y valor-> en un objeto
        bundle.putString("fullname", "Juan Vilchez");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.APP_OPEN, bundle);
        mFirebaseAnalytics.setUserProperty("username","jvilchez");
